...
function Home() {
  ...
  return (
    <div className="p-4 min-h-screen bg-[rgba(0,0,0,0.9)]">
      <div className="rounded-lg p-4 mb-25 mt-20">
        <h2 className="text-6xl font-semibold text-white mb-9 text-center">
          Bem-vinda ao <strong className="text-purple-400">Donas da Bola!</strong>
        </h2>
        <p className="text-2xl text-white/90 leading-relaxed mb-2 text-center pl-15 pr-15">
      ...
      <div>
          <h1 className="text-center font-semibold p-4 text-white bg-purple-600 ml-200 mr-200 text-3xl border border-black rounded-lg  mb-5">Eventos</h1>
      </div>
